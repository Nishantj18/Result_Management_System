...
class Stud:
    def __init__(self,root):
        ...
        self.bg_Img=ImageTk.PhotoImage(file="F:\project\logo1.jpg")
        self.pass_Img=ImageTk.PhotoImage(file=r"F:\project\pass.png")
        self.user_Img=ImageTk.PhotoImage(file=r"F:\project\user_icon.png")
    ...
    def login(self): 
        if self.uname.get()=="" or self.pass1.get()=="":
            ...
            try:
                ...
                row=cur.fetchone()
                os.system("python F:/project/stud_dashboard.py")
