...
class EditClass:
    ...
    #Entry Fields 2
        ...
        # admission1 = Entry(self.root,textvariable=self.var_adm_date,font=("times new roman",15,"bold"),bg="lightyellow").place(x=480,y=140,width=200)

        # self.course1 = ttk.Combobox(self.root,textvariable=self.var_course,values=self.course_list,font=("times new roman",15,"bold"),state="readonly",justify=CENTER)
